...
def main():
    ...
    # 设置任务类型和任务序号
    task_type = '2'  # 默认设置为循环任务
    task_choice = '1'  # 默认选择第一个任务
    start_task_index = int(task_choice) - 1
    start_account_index = 0

    perform_tasks(accounts, tasks_list, start_task_index, start_account_index, is_single_task=task_type == '1')

# 添加 main_function 调用 main 函数
def main_function():
    main()
